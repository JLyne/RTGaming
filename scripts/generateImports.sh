...
echo "[RTGaming] State: Generate Imports"
...
paperserver="$basedir/Purpur/Purpur-Server/src/main/java/net/minecraft/server"
...
cd $basedir/mc-dev
$gitcmd add . -A
$gitcmd commit . -m "rtgaming-base"
$gitcmd tag -a "rtgaming-base" -m "rtgaming-base" 2>/dev/null
