...
echo "  This will apply all of RTGaming patches on top of the Paper."
echo "  "
...
(applyPatch Purpur/Purpur-API ${FORK_NAME}-API HEAD api $API_REPO 0 2 &&
applyPatch Purpur/Purpur-Server ${FORK_NAME}-Server HEAD server $SERVER_REPO 1 2) || exit 1
