...
echo "  - $(bashcolor 1 32)2$(bashcolorend) : RTGaming"
echo "----------------------------------------"
# SCRIPT HEADER end
...
# After the patching, it will copying sources that do no exist in the rtgaming workspace but referenced in rtgaming patches into our workspace, depending on the content of our patches, this will be addressed by calling importSources.sh.
...
# patch paper
echo "  $(bashcolor 1 32)(0/$subtasks)$(bashcolorend) - Apply patches of Purpur.."
echo "  "
paperVer=$(gethead Purpur)
paperdir
bash -x purpur upstream
bash -x purpur patch
...
#
#echo "  $(bashcolor 1 32)($subtasks/$subtasks) Succeed$(bashcolorend) - Submodules have been updated, regenerated and imported, run 'rtgaming patch' to test/fix patches, and by 'rtgaming rbp' to rebuild patches that fixed with the updated upstream."
#echo "  "
#
